...
// Request
export const AddRepositoryReqSchema = z.object({
  url: z.string(),
...
export type AddRepositorySuccessRes = z.infer<typeof AddRepositorySuccessResSchema>;
export type AddRepositoryFailureRes = z.infer<typeof AddRepositoryFailureResSchema>;
